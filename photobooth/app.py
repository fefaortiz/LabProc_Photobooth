...
class PhotoboothApp:
    def __init__(self) -> None:
        ...
        self.font_title = pygame.font.Font(str(config.FONT_COQUETTE), 78)
        self.font_subtitle = pygame.font.Font(str(config.FONT_BOLD), 38)
        self.font_button = pygame.font.Font(str(config.FONT_COQUETTE), 42)
        self.font_countdown = pygame.font.Font(str(config.FONT_REGULAR), 250)
        self.font_small = pygame.font.Font(str(config.FONT_COQUETTE), 30)
